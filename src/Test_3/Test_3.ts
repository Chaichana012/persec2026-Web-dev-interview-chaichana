...
function Autocomplete(search: string, item: string[], maxResult: number): string[] {
...
function runTest_3(testName: string, input: string, item: string[], maxResult: number, expectedOut: string[]) {
